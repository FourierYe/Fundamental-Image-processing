function  car_character = detect_car_license_plate_v3(car_license_plate,alphanumeric_templates)
...
for i = 1:length_character
    ...
    for j = 1:length_alphabet
        ...
        im_test_1 = imerode(character_im{i},E_strel_1);
        
        disk_se = strel('disk',1);
        
        E_strel_1 = imdilate(E_strel_1,disk_se);
        
        E_strel_2 = get_boundary(E_strel_1);
        
        im_test_2 = imerode(~character_im{i}, E_strel_2);
